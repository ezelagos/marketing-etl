...
with DAG(
    ...
    t1_generar = BashOperator(
        ...
        bash_command='/home/eze/proyecto_prueba/venv/bin/python /home/eze/proyecto_prueba/marketing_data_gen.py'
    )

    t2_unificar = BashOperator(
        task_id='unificar_csvs',
        bash_command='/home/eze/proyecto_prueba/venv/bin/python /home/eze/proyecto_prueba/data_merger.py'
    )

    tt3_analizar = BashOperator(
        task_id='generar_reporte',
        bash_command='/home/eze/proyecto_prueba/venv/bin/python /home/eze/proyecto_prueba/data_analysis.py'
    )
